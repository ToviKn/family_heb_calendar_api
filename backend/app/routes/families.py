...
from app.services.family_service import add_member as add_member_service
from app.services.family_service import approve_join_request as approve_join_request_service
from app.services.family_service import create_family as create_family_service
from app.services.family_service import create_join_request as create_join_request_service
from app.services.family_service import list_pending_join_requests as list_pending_join_requests_service
from app.services.family_service import reject_join_request as reject_join_request_service
...
def request_to_join_family(family_id: int, db: DbSession, current_user: CurrentUser) -> FamilyJoinRequestResponse:
    result = create_join_request_service(db, family_id, current_user.id)
